// Compilar con: g++ -std=c++11 -I. -o prodcons Semaphore.cpp prodcons.cpp -pthread
...
int vec[tam_vec]; // buffer donde se introducirán/leeran los datos
Semaphore libres = tam_vec, ocupadas = 0, ex_m = 1; // Semáforos para controlar
// él número de casillas libres y ocupadas del vector, y otro para controlar
...
int producir_dato()
{
   ...
   //cout << "Primera libre: " << primera_libre << endl << flush;
