// Compilar con:
// g++ -std=c++11 -pthread -o prodcons1_su_lifo_multiples prodcons1_su_lifo_multiples.cpp HoareMonitor.cpp
// -----------------------------------------------------------------------------
//
...
int ProdCons1SU::leer( )
{
  ...
  //cout << "      primera_libre: " << primera_libre << "      ";
   assert( 0 < primera_libre  );
   primera_libre-- ;
   const int valor = buffer[primera_libre] ;
   //cout << endl << "                         ultimo valor leido: " << buffer[primera_libre] << endl;
...
void ProdCons1SU::escribir( int valor )
{
   ...
   //cout << endl << "ultimo valor escrito: " << buffer[primera_libre] << endl;
   primera_libre++ ;
